...
describe('ContainerComponent', () => {
    ...
    let scrollDispatcherSpy: any;  // originally Partial<ScrollDispatcher>
    ...
    beforeEach(() => {
        ...
        scrollDispatcherSpy = {
            ...
            register: vi.fn().mockName("ScrollDispatcher.register"),
            deregister: vi.fn().mockName("ScrollDispatcher.deregister")
        };
        ...
        scrollDispatcherSpy.scrolled.mockReturnValue(scrollSubject.asObservable());

        fixture = createStandaloneComponentFixture(ContainerComponent, [
        ...
        vi.spyOn(component.scrollinfo, 'emit');
...
describe('ContainerComponent - Error Handling', () => {
    ...
    beforeEach(() => {
        ...
        scrollDispatcherSpy.scrolled.mockReturnValue(new Subject<CdkScrollable>().asObservable());
