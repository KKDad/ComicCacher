...
public class ResponseBuilder {
     ...
     * @return ResponseEntity with HTTP 201 status containing the item wrapped in an ApiResponse
     */
     ...
     * @return ResponseEntity with the specified status containing the error message wrapped in an ApiResponse
     */
