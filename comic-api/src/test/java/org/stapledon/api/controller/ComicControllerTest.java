...
class ComicControllerTest {
        ...
        void retrieveAllComics() throws Exception {
                when(comicManagementFacade.getAllComics()).thenReturn(List.of(
                                getComicItem(42, "Art Comics Daily", "Bebe Williams",
                                                "Art Comics Daily is a pioneering webcomic first published in March 1995 by Bebe Williams, who lives in Arlington, Virginia, United States. The webcomic was published on the Internet rather than in print in order to reserve some artistic freedom. Art Comics Daily has been on permanent hiatus since 2007.",
                                                1995, 5, 31, 2007),
                                getComicItem(187, "The Dysfunctional Family Circus", "Bil Keane",
                                                "The Dysfunctional Family Circus is the name of several long-running parodies of the syndicated api strip The Family Circus, featuring either Bil Keane's artwork with altered captions, or (less often) original artwork made to appear like the targeted strips.",
                                                1989, 8, 3, 2013)));
        ...
        void retrieveComicDetails() throws Exception {
                when(comicManagementFacade.getComic(42)).thenReturn(
                                Optional.of(getComicItem(42, "Art Comics Daily", "Bebe Williams",
                                                "Art Comics Daily is a pioneering webcomic first published in March 1995 by Bebe Williams, who lives in Arlington, Virginia, United States. The webcomic was published on the Internet rather than in print in order to reserve some artistic freedom. Art Comics Daily has been on permanent hiatus since 2007.",
                                                1995, 5, 31, 2007)));
        ...
        void createComicDetailsTest() throws Exception {
                var comic = getComicItem(42, "Art Comics Daily", "Bebe Williams",
                                "Art Comics Daily is a pioneering webcomic first published in March 1995 by Bebe Williams, who lives in Arlington, Virginia, United States. The webcomic was published on the Internet rather than in print in order to reserve some artistic freedom. Art Comics Daily has been on permanent hiatus since 2007.",
                                1995, 5, 31, 2007);
        ...
        void retrieveNextComicImage() throws Exception {
                ...
                verify(comicManagementFacade, times(1)).getComicStrip(eq(42), eq(Direction.FORWARD),
                                any(LocalDate.class));
        }
        ...
        void retrievePreviousComicImage() throws Exception {
                ...
                verify(comicManagementFacade, times(1)).getComicStrip(eq(42), eq(Direction.BACKWARD),
                                any(LocalDate.class));
        }
        ...
        private static ComicItem getComicItem(int id, String name, String author, String description, int year,
                        int month, int dayOfMonth, int endYear) {
