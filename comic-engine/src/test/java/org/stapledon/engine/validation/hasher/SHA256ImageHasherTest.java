...
class SHA256ImageHasherTest {
    ...
    void calculateHashSinglePixelDifferenceProducesDifferentHash() throws Exception {
        // SHA-256 is byte-exact, so even a single pixel difference should produce a
        // different hash
        ...
        assertThat(hash2).as("Images with single pixel difference should have different SHA-256 hashes")
                .isNotEqualTo(hash1);
    }
