 ...
 * Now delegates to ComicManagementFacade for actual comic operations.
 *
 * @deprecated This class is maintained for backward compatibility.
 *             New code should use ComicManagementFacade directly.
 */
...
public class ComicCacher {
     ...
     * @deprecated Use {@link ComicManagementFacade#updateAllComics()} instead
     */
    @Deprecated(since = "1.2.0")
    public boolean cacheAll() {
        log.debug("ComicCacher.cacheAll() delegating to ComicManagementFacade.updateAllComics()");
     ...
     * @deprecated Use {@link ComicManagementFacade#updateComic(int)} instead
     */
    @Deprecated(since = "1.2.0")
    ...
    public boolean cacheSingle(ComicItem comic) {
        log.debug("ComicCacher.cacheSingle() delegating to ComicManagementFacade.updateComic()");
